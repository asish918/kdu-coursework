...
/**
 * A dummy node for easy initialisation of the Doubly Linked List
 * @param <T> Data type for the Doubly Linked List
 */
public class DummyNode<T> implements LinkedListNode<T> {
    ...
    @Override
    public void detach() {
        // Dummy node is already detached so the given function is empty
    }
